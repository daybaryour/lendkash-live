        ...
        font-size:15px">
            ...
            <tr>
                <td valign="top" style="border:1px solid #2A05A7; padding:15px">
                    ...
                    <p>You recently requested to reset your password for your Lendkash.</p>
                    <p>Your four digit code is <strong>{{$data['code']}}.</strong> Please verify your email and start exploring Lendkash</p>
