    ...
    <div class="container-fluid">
       ...
       <div class="page-title-row d-flex align-items-center">
            <div class="page-title-row__left">
                <h1 class="page-title-row__left__title text-capitalize">Wallet Commission</h1>
            </div>
                ...
                <div class="left">
                    ...
                    <form action="" id="ratingFilterForm">
                        <div class="filterForm__field flex-wrap pr-0">
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control" placeholder="Total Amount" id="loanAmount">
                            </div>
                            <div class="form-group">
                                <input type="text" class="form-control" placeholder="Commission Received" id="receiveAmount">
                            </div>
                            <div class="form-group">
                                <input type="text" class="form-control" placeholder="Commission Date" id="commissionDate" class="form-control datetimepicker-input" data-target="#commissionDate" data-toggle="datetimepicker">
                            </div>
                ...
                <table class="table" id="commissionList_datatable">
                    <thead>
                        <tr>
                            ...
                            <th><span class="sorting">Transaction Amount <i class="icon-naira"></i></span></th>
                            <th><span class="sorting">Commission Recived <i class="icon-naira"></i></span></th>
    ...
    function fillDatatable() {
        $(document).ready(function () {
            ...
            $('#commissionList_datatable').DataTable({
                ...
                ajax: {
                    url: SITEURL + "/admin/wallet-commission-list",
                    data: {
                        requestId: $('#requestId').val(),
                        userName: $('#userName').val(),
                        loanAmount: $('#loanAmount').val(),
                        receiveAmount: $('#receiveAmount').val(),
                        commissionDate: $('#commissionDate').val(),
                    },
                    beforeSend: function(){
                        $('#commissioList').html('');
                    },
