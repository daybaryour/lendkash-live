    ...
    <div class="container-fluid">
       ...
       <div class="page-title-row d-flex align-items-center">
            <div class="page-title-row__left">
                <h1 class="page-title-row__left__title text-capitalize">Loan Commission</h1>
            </div>
                ...
                <table class="table" id="commissionList_datatable">
                    <thead>
                        <tr>
                            ...
                            <th><span class="sorting">Total Amount <i class="icon-naira"></i></span></th>
    ...
    function fillDatatable() {
        $(document).ready(function () {
            ...
            $('#commissionList_datatable').DataTable({
                ...
                ajax: {
                    url: SITEURL + "/admin/commission-list",
                    data: {
