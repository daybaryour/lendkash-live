...
<div class="filterForm mt-lg-3" id="searchFilter">
    ...
    <div class="flex-row justify-content-between align-items-end">
        <div class="left">
            ...
            <form action="" id="approvalFilterForm">
...
<div class="page-title-row d-flex align-items-center justify-content-end m-lg-0">
 ...
 <div class="common-table">
    <div class="table-responsive">
        <table class="table" id="pending_datatable">
            <thead>
                <tr>
                    <th><span>#ID</span></th>
                    <th><span>User Name</span></th>
                    <th><span>Loan Amount <i class="icon-naira"></i></span></th>
                    <th><span>Loan Interest</span></th>
                    <th><span>Loan Terms (In Months)</span></th>
                    <th><span>Total EMI</span></th>
                    <th><span>Payment Frequency</span></th>
...
function fillDatatable() {
    ...
    $(document).ready(function () {
        ...
        $('#filter_search').click(function () {
            $('#pending_datatable').DataTable().destroy();
            fillDatatable();
        });
        $('#resetForm').click(function () {
            $('#approvalFilterForm')[0].reset();
