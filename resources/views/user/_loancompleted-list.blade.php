        ...
        <div class="left">
            ...
            <form action="" id="waitingFilterForm">
                <div class="filterForm__field flex-wrap">
                    ...
                    <div class="form-group">
                        <div class="icon calender-icon">
                            <input type="text" name="from" id="loanCompleteDate" placeholder="Loan Completed Date" class="form-control datetimepicker-input" data-target="#loanCompleteDate" data-toggle="datetimepicker">
                        </div>
                    </div>
                    <div class="form-group">
...
<div class="common-table">
    <div class="table-responsive">
        <table class="table" id="completedLoan_datatable">
            <thead>
                <tr>
                    ...
                    <th><span class="sorting">Loan Requested Date and Time</span></th>
                    <th><span class="sorting">Loan Completed Date and Time</span></th>
                    <th><span class="sorting">Loan Interest</span></th>
                    <th><span class="sorting">Requested Amount <i class="icon-naira"></i></span></th>
...
<script>
    ...
    function fillDatatable() {
        $(document).ready(function () {
            ...
            $('#completedLoan_datatable').DataTable({
                processing: true,
                serverSide: true,
                searching: false,
                lengthMenu: false,
                ...
                ajax: {
                    ...
                    data: {
                        ...
                        LoanEMI: $('#LoanEMI').val(),
                        loanCompleteDate: $('#loanCompleteDate').val(),
    ...
    $(document).ready(function () {
        ...
        $('#filter_search').click(function () {
            $('#completedLoan_datatable').DataTable().destroy();
            fillDatatable();
        });
    ...
    $('#loanRequestDate, #loanCompleteDate').datetimepicker({// initialize datepicker
        useCurrent: false,
        format: "L",
        // minDate: moment(),
        ignoreReadonly: true,
