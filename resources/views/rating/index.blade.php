    ...
    <div class="container-fluid">
       ...
       <div class="page-title-row d-flex align-items-center">
            <div class="page-title-row__left">
                <h1 class="page-title-row__left__title text-capitalize">Reviews & Ratings</h1>
            </div>
                    ...
                    <form action="" id="ratingFilterForm">
                        <div class="filterForm__field flex-wrap pr-0">
                            <div class="form-group">
                                <input type="text" class="form-control" placeholder="Application Id" id="loanRequestId">
                            </div>
                            <div class="form-group">
        ...
        <div class="common-table">
            <div class="table-responsive">
                <table class="table" id="ratingList_datatable">
                    <thead>
                        <tr>
                            <th><span class="sorting">#ID</span></th>
                            <th><span class="sorting">Borrower Name</span></th>
...
<script>
    ...
    function fillDatatable() {
        $(document).ready(function () {
            ...
            $('#ratingList_datatable').DataTable({
                processing: true,
                serverSide: true,
                searching: false,
                lengthMenu: false,
                ...
                ajax: {
                    url: SITEURL + "/admin/reviews-and-ratings",
                    data: {
    ...
    $(document).ready(function () {
        ...
        $('#filter_search').click(function () {
            $('#ratingList_datatable').DataTable().destroy();
            fillDatatable();
        });
