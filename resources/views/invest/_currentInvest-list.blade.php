                ...
                <div class="filterForm__field flex-wrap">
                    ...
                    <div class="form-group">
                        <div class="icon calender-icon">
                            <input type="text" name="from" id="startDate" placeholder="Date of Invest" class="form-control datetimepicker-input" data-target="#startDate" data-toggle="datetimepicker">
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="icon calender-icon">
