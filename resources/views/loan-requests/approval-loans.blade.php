    ...
    <div class="container-fluid">
       ...
       <div class="page-title-row d-flex align-items-center">
            <div class="page-title-row__left">
                <h1 class="page-title-row__left__title text-capitalize">Manage Loan Request</h1>
            </div>
        ...
        <div class="common-table">
            <div class="table-responsive">
                <table class="table" id="approvalLoan_datatable">
                    <thead>
                        <tr>
                            ...
                            <th><span class="sorting">Description for loan</span></th>
                            <th>Action</th>
                        </tr>
                    </thead>
                    <tbody id="loanList">
...
<script>
    ...
    function fillDatatable() {
        ...
        $(document).ready(function () {
            ...
            $('#approvalLoan_datatable').DataTable({
                processing: true,
                serverSide: true,
                searching: false,
                lengthMenu: false,
                ...
                ajax: {
                    url: SITEURL + "/admin/approval-loans",
                    data: {
    ...
    $(document).ready(function () {
        ...
        $('#filter_search').click(function () {
            $('#approvalLoan_datatable').DataTable().destroy();
            fillDatatable();
        });
    ...
    $.ajax({
        ...
        success: function (res) {
            ...
            if (res.success == 'false') {
                ...
                var oTable = $('#approvalLoan_datatable').dataTable();
                oTable.fnDraw(false);
